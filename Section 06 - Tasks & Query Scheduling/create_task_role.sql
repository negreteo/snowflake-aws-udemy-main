...
-- Assigns grant permissions to objects
...
grant execute task on account to role task_owner; -- Execute task happens at a role level, not schema level
...
grant role task_owner to user negreteo;
