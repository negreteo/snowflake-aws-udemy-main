...
url = 's3://s3-on-dev-ecn1-snowflake-001/ecommerce_dev/lineitem/lineitem_parquet/'
...
create table lineitem_raw_parquet (src variant);

-- Ingest data into the raw table from staged location --- 
copy into lineitem_raw_parquet from @stg_lineitem_parquet_dev ON_ERROR = ABORT_STATEMENT;
